...
% timetag
t_course = table2array(M(:,2)); % [s]
t_fine = table2array(M(:,3));

% attitude data
posX = table2array(M(:,4)); % [ft]
...
t2A_koz = timevec((PSARJ>=255 & PSARJ<=289) | (PSARJ == 270 & P42A_BGA >=24 & P42A_BGA <= 150) | (PSARJ == 270 & P42A_BGA >=229 & P42A_BGA <= 337));
